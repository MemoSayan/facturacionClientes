...
public class FacturaController {
	...
	public String ver(@PathVariable(value = "id") Long id,
			Model model,
			RedirectAttributes flash) {
		Factura factura = clienteService.fetchByIdWClienteWIFacturaWProducto(id); //clienteService.findFacturaById(id);
	...
	public String eliminar(@PathVariable(value = "id")Long id, RedirectAttributes flash) { 
		...
		flash.addFlashAttribute("error", "La facura no existe en la base de datos, no se pudo eliminar");
		return "redirect:/listar";
	}
}
